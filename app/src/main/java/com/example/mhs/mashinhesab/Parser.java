...
//    }
     ...
     */
    public boolean isMinus(final char c)
    {
        return c == '-';
    }
     ...
     */
    public boolean isDelimeter(final char c)
    {
        return "&|<>=+/*%^!".indexOf(c) != -1;
    }
     ...
     */
    public boolean isNotDelimeter(final char c)
    {
        return "&|<>=+-/*%^!()".indexOf(c) != -1;
    }
     ...
     */
    public boolean isDigitDot(final char c)
    {
     ...
     * equal to "pi", "e", etc.
     */
    public boolean isLegalVariableName(String name)
    {
     ...
     */
    public void getToken() throws Error
    {
        token_type = TOKENTYPE.NOTHING;
     ...
     */
    public double parse_level1() throws Error
    {
     ...
     */
    public double parse_level2() throws Error
    {
        OPERATOR op_id;
        double ans;
        ans = parse_level3();
     ...
     */
    public double parse_level3() throws Error
    {
        OPERATOR op_id;
        double ans;
        ans = parse_level4();
     ...
     * add or subtract
     */
    public double parse_level4() throws Error
    {
        OPERATOR op_id;
        double ans;
        ans = parse_level5();
     ...
     */
    public double parse_level5() throws Error
    {
        OPERATOR op_id;
        double ans;
        ans = parse_level6();
     ...
     * power
     */
    public double parse_level6() throws Error
    {
        OPERATOR op_id;
        double ans;
        ans = parse_level7();
     ...
     * Factorial
     */
    public double parse_level7() throws Error
    {
        OPERATOR op_id;
        double ans;
        ans = parse_level8();
     ...
     * Unary minus
     */
    public double parse_level8() throws Error
    {
        double ans;
     ...
     * functions
     */
    public double parse_level9() throws Error
    {
        String fn_name;
        double ans;
     ...
     */
    public double parse_level10() throws Error
    {
    ...
    public double parse_number() throws Error
    {
        double ans = 0.0;
     ...
     */
    public OPERATOR get_operator_id(final String op_name)
    {
        // level 2
     ...
     */
    public double eval_operator(final OPERATOR op_id, final double lhs, final double rhs) throws Error
    {
        switch (op_id)
        {
            // level 2
     ...
     * evaluate a function
     */
    public double eval_function(final String fn_name, final double value) throws Error
    {
     ...
     * evaluate a variable
     */
    public double eval_variable(final String var_name) throws Error
    {
